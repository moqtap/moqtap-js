// Draft-07 message type wire IDs
...
export const SETUP_PARAM_ROLE = 0x00n
...
// Data stream type IDs (context disambiguates from control messages with same IDs)
export const MSG_OBJECT_DATAGRAM = 0x01n
export const MSG_STREAM_HEADER_SUBGROUP = 0x04n
export const MSG_FETCH_HEADER = 0x05n
