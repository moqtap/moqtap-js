import type { Draft07MessageType } from './types.js'

export const CONTROL_MESSAGES: ReadonlySet<Draft07MessageType> = new Set([
  'client_setup',
  'server_setup',
  'subscribe',
  'subscribe_ok',
...
export const DATA_MESSAGES: ReadonlySet<Draft07MessageType> = new Set([
  'object_datagram',
  'stream_header_subgroup',
])

// Messages that only a client can send
export const CLIENT_ONLY_MESSAGES: ReadonlySet<Draft07MessageType> = new Set([
  'client_setup',
  'subscribe',
  'subscribe_update',
  'unsubscribe',
...
export const SERVER_ONLY_MESSAGES: ReadonlySet<Draft07MessageType> = new Set([
  'server_setup',
  'subscribe_ok',
  'subscribe_error',
  'subscribe_done',
...
export function getLegalOutgoing(
  phase: string,
  role: 'client' | 'server',
): Set<Draft07MessageType> {
  const legal = new Set<Draft07MessageType>()
