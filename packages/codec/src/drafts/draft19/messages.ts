// Draft-19 message type wire IDs
...
export const SETUP_OPT_MAX_FILTER_RANGES = 0x06n // NEW in draft-19
export const SETUP_OPT_MOQT_IMPLEMENTATION = 0x07n
export const SETUP_OPT_MAX_REQUEST_UPDATES = 0x08n // NEW in draft-19
