import type { Draft21MessageType } from './types.js'

// All draft-21 control messages (draft-21 Section 9, Table 5)
export const CONTROL_MESSAGES: ReadonlySet<Draft21MessageType> = new Set([
  'setup',
  'subscribe',
  'subscribe_ok',
  'request_update',
...
// Draft-21 has a single SETUP message — both roles can send it
export const CLIENT_ONLY_MESSAGES: ReadonlySet<Draft21MessageType> = new Set<Draft21MessageType>()

export const SERVER_ONLY_MESSAGES: ReadonlySet<Draft21MessageType> = new Set<Draft21MessageType>()

// Messages that are bidirectional (both client and server can send)
export const BIDIRECTIONAL_MESSAGES: ReadonlySet<Draft21MessageType> = new Set([
  'setup',
  'subscribe',
  'subscribe_ok',
  'request_update',
 ...
 * (request) stream — draft-21 Section 6.3, and the rows marked "First" in the
 ...
 */
export const REQUEST_STREAM_OPENERS: ReadonlySet<Draft21MessageType> = new Set([
  'subscribe',
  'publish',
  'fetch',
  'track_status',
...
export function getLegalOutgoing(
  phase: string,
  _role: 'client' | 'server',
): Set<Draft21MessageType> {
  const legal = new Set<Draft21MessageType>()
