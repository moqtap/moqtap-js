// Draft-21 message type wire IDs (draft-21 Section 9, Table 5).
//
...
/** NEW in draft-20 — Section 9.10. Unilateral publisher→subscriber notification. */
export const MSG_PUBLISH_STATE_NOTIFY = 0x22n
// PUBLISH_OK is not a codepoint of its own: it is a REQUEST_OK (0x07) sent in
// reply to a PUBLISH (draft-21 Section 9.3). Same for REQUEST_UPDATE_OK,
...
// Unchanged from draft-19 (draft-21 Section 16.4, Table 10).
