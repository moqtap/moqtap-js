...
// Authorization token parameter (nested structure)
...
export interface Draft15SetupParams {
  ...
  authorization_token?: readonly AuthorizationToken[] // 0x03 odd (length-prefixed, nested)
...
export interface Draft15Params {
  ...
  publisher_priority?: bigint // 0x0e even
  forward?: bigint // 0x10 even
  ...
  dynamic_groups?: bigint // 0x30 even
  new_group_request?: bigint // 0x32 even
  unknown?: UnknownParam[]
}
