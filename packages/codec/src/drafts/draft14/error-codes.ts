// Draft-14 error, status and termination code registries.
...
export type PublishErrorCodeValue = (typeof PublishErrorCode)[keyof typeof PublishErrorCode]
...
export const SubscribeNamespaceErrorCode = {
  InternalError: 0x0n,
  Unauthorized: 0x1n,
  Timeout: 0x2n,
  NotSupported: 0x3n,
...
export type SubscribeNamespaceErrorCodeValue =
  (typeof SubscribeNamespaceErrorCode)[keyof typeof SubscribeNamespaceErrorCode]
