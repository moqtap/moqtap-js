// Draft-13 message type wire IDs
...
// Setup parameter type IDs for auth (same even/odd encoding)
export const SETUP_PARAM_AUTHORIZATION_TOKEN = 0x03n // odd: length-prefixed
export const SETUP_PARAM_MAX_AUTH_TOKEN_CACHE_SIZE = 0x04n // even: varint
