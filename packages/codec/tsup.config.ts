...
export default defineConfig({
  ...
  entry: {
    ...
    draft07: 'src/drafts/draft07/index.ts',
    'draft07-session': 'src/drafts/draft07/session.ts',
    draft08: 'src/drafts/draft08/index.ts',
    'draft08-session': 'src/drafts/draft08/session.ts',
    draft09: 'src/drafts/draft09/index.ts',
    'draft09-session': 'src/drafts/draft09/session.ts',
