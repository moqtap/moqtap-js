/**
 * `@moqtap/collector/draft12` -- the draft-partitioned entry point.
 *
 * Importing this reaches draft-12's decoder and nothing else: no other draft's
 ...
 *
 * `draft12` rather than `d12`: every entry in this workspace is zero-padded,
 * and `@moqtap/codec` ships `./draft07` through `./draft21`.
 *
 * Draft-12 negotiates the ALPN `moq-00`, which it shares with every draft
...
export { adapter, DRAFT12_ADAPTER, draft } from './index.js'
