/**
 * `@moqtap/collector/draft11` -- the draft-partitioned entry point.
 *
 * Importing this reaches draft-11's decoder and nothing else: no other draft's
 ...
 *
 * `draft11` rather than `d11`: every entry in this workspace is zero-padded,
 * and `@moqtap/codec` ships `./draft07` through `./draft21`.
 *
 * Draft-11 negotiates the ALPN `moq-00`, which it shares with every draft
...
export { adapter, DRAFT11_ADAPTER, draft } from './index.js'
