/**
 * `@moqtap/collector/draft16` -- the draft-partitioned entry point.
 *
 * Importing this reaches draft-16's decoder and nothing else: no other draft's
...
export { adapter, DRAFT16_ADAPTER, draft } from './index.js'
