/**
 * `@moqtap/collector/draft10` -- the draft-partitioned entry point.
 *
 * Importing this reaches draft-10's decoder and nothing else: no other draft's
 ...
 *
 * `draft10` rather than `d10`: every entry in this workspace is zero-padded,
 * and `@moqtap/codec` ships `./draft07` through `./draft20`.
 *
 * Draft-10 negotiates the ALPN `moq-00`, which it shares with every draft
...
export { adapter, DRAFT10_ADAPTER, draft } from './index.js'
