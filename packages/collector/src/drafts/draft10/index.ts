/**
 * The draft-10 adapter.
 *
 * Identical to draft-09 on the wire for everything this walk reads.
 *
 * **This module is the boundary of the draft-10 chunk.** It is reached only
 * through `DRAFT_LOADERS[10]`'s `() => import('../drafts/draft10/index.js')`, and
 * the `@moqtap/codec/draft10` specifier below is a **static string literal** on
...
import { decodeDatagram, decodeMessage, redactAuthTokens } from '@moqtap/codec/draft10'
...
/**
 * draft-10's data-stream dialect, read off `drafts/draft10/data-streams.ts`.
 *
 ...
 */
export const draft: SupportedDraft = 10

/** The one adapter instance for draft-10. Stateless, so one is enough. */
export const DRAFT10_ADAPTER: DraftAdapter = /*#__PURE__*/ Object.freeze(
  makeAdapter(draft, PROTOCOL_STRINGS[10], RFC9000_READER, DIALECT, {
    decodeMessage,
    decodeDatagram,
    redactAuthTokens,
  }),
...
export { DRAFT10_ADAPTER as adapter }
