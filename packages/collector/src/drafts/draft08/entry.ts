/**
 * `@moqtap/collector/draft08` -- the draft-partitioned entry point.
 *
 * Importing this reaches draft-08's decoder and nothing else: no other draft's
...
export { adapter, DRAFT08_ADAPTER, draft } from './index.js'
