/**
 * `@moqtap/collector/draft13` -- the draft-partitioned entry point.
 *
 * Importing this reaches draft-13's decoder and nothing else: no other draft's
 ...
 *
 * `draft13` rather than `d13`: every entry in this workspace is zero-padded,
 * and `@moqtap/codec` ships `./draft07` through `./draft21`.
 *
 * Draft-13 negotiates the ALPN `moq-00`, which it shares with every draft
...
export { adapter, DRAFT13_ADAPTER, draft } from './index.js'
