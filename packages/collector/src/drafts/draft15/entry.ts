/**
 * `@moqtap/collector/draft15` -- the draft-partitioned entry point.
 *
 * Importing this reaches draft-15's decoder and nothing else: no other draft's
 ...
 *
 * `draft15` rather than `d15`: every entry in this workspace is zero-padded,
 * and `@moqtap/codec` ships `./draft07` through `./draft20`.
 *
 * Draft-15 negotiates the ALPN `moqt-15`, which from draft-15 is the only
...
export { adapter, DRAFT15_ADAPTER, draft } from './index.js'
